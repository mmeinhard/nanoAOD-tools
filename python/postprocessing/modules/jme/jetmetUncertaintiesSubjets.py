	...
	self.redoJEC = redoJEC
        ...
        if "AK4" in jetType : 
            ...
            if self.subjetJEC:
                ...
                self.jerInputFileName = "Fall17_V3_MC_PtResolution_AK4PFchs.txt"
                self.jerUncertaintyInputFileName = "Fall17_V3_MC_SF_AK4PFchs.txt"
                self.jetSmearer = jetSmearer(globalTag, jetType, self.jerInputFileName, self.jerUncertaintyInputFileName)
            if not self.noGroom:
                self.doGroomed = True
            else:
            ...
            self.jerInputFileName = "Fall17_V3_MC_PtResolution_AK8PFPuppi.txt"
            self.jerUncertaintyInputFileName = "Fall17_V3_MC_SF_AK8PFPuppi.txt"
        ...
        if jetType == "HTTV2" and len(jesUncertainties) == 1 and jesUncertainties[0] == "Total":
            self.jesUncertaintyInputFileName = "Fall17_17Nov2017_V32_MC_Uncertainty_AK8PFPuppi.txt"
            if self.subjetJEC:
                self.jesUncertaintyInputFileName = "Fall17_17Nov2017_V32_MC_Uncertainty_AK4PFchs.txt"
        elif jetType == "HTTV2" and jesUncertainties[0] == "All":
            self.jesUncertaintyInputFileName = "Fall17_17Nov2017_V32_MC_UncertaintySources_AK8PFPuppi.txt"
            if self.subjetJEC:
                self.jesUncertaintyInputFileName = "Fall17_17Nov2017_V32_MC_UncertaintySources_AK4PFchs.txt"
...
jetmetUncertainties2017AK8PuppiSubjet = lambda : jetmetUncertaintiesProducer("2017", "Fall17_17Nov2017_V32_MC", [ "Total" ], jetType="AK8PFPuppi",noGroom=True,subjetJEC=True)
jetmetUncertainties2017AK8PuppiSubjetAll = lambda : jetmetUncertaintiesProducer("2017", "Fall17_17Nov2017_V32_MC", ["All"], jetType="AK8PFPuppi",noGroom=True,subjetJEC=True)


jetmetUncertainties2017HTT = lambda : jetmetUncertaintiesProducer("2017", "Fall17_17Nov2017_V32_MC", [ "Total" ], jetType="HTTV2",noGroom=True)
jetmetUncertainties2017HTTAll = lambda : jetmetUncertaintiesProducer("2017", "Fall17_17Nov2017_V32_MC", ["All"], jetType="HTTV2",noGroom=True)
jetmetUncertainties2017HTTSubjet = lambda : jetmetUncertaintiesProducer("2017", "Fall17_17Nov2017_V32_MC", [ "Total" ], jetType="HTTV2",noGroom=True,subjetJEC=True)
jetmetUncertainties2017HTTSubjetAll = lambda : jetmetUncertaintiesProducer("2017", "Fall17_17Nov2017_V32_MC", ["All"], jetType="HTTV2",noGroom=True,subjetJEC=True)
